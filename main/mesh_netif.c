...
// Estrucura de datos que almacena la informacion de la subnet
...
//Crea la tabla DHCPS para la red interna del padre hacia los hijos
...
//Funcion que recibe las tareas enviadas por la red mesh
...
//Funcion que libera espacio de memoria usado por la red mesh para envio y recepcion de datos
static void mesh_free(void *h, void* buffer)
{
    free(buffer);
}
//Funcion se encarga de transmitir la informacion de cada nodo padre a los hijos
...
//Funcion que se encarga de enmascarar a la funcion "mesh_netif_transmit_from_root_ap"
...
//Funcion que transmite los datos desde un componente hijo hacia su nodo padre
...
//Funcion que se encarga de enmascarar a la funcion "mesh_netif_transmit_from_node_sta"
...
//Funcion que se encarga de iniciar el bus de conexion de datos del nodo padre
...
//Funcion que se encarga de iniciar el bus de conexion de los nodos hijos
...
//Libera el espacio de mmetoria ocupado por el driver de conexion
void mesh_delete_if_driver(mesh_netif_driver_t driver)
{
    free(driver);
}
//Crear el driver de conexion para la red mesh
...
//Funcion para conectarse al router y transmitir los datos al internet
...
//Inicia la red mesh tanto para nodos padres como para hijos 
...
//Funcion para iniciar el access point del nodo padre
...
//Funcion del nodo padre para conectarse al router
...
//Funcion que inicia la conexion mesh
...
//Funcion que inicia el access point del nodo padre
...
//Funcion para controlar lo inicios dependiendo de si es un nodo padre o un nodo hijo
...
//Funcion para detener los conexiones mesh
...
//Funcion que retorna la direccion mal del dispositivo
